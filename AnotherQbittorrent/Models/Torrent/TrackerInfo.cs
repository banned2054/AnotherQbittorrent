...
public class TrackerInfo
{
    ...
    [JsonPropertyName("status")]         public EnumTrackerStatus Status        { get; set; }
    ...
    [JsonPropertyName("num_leeches")]    public int               NumLeeches    { get; set; }
    [JsonPropertyName("num_downloaded")] public int               NumDownloaded { get; set; }
